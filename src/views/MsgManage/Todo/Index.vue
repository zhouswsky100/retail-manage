    ...
    <ToolBar v-if="!flg">
      <div style="height: 50px;">
       ...
       <el-collapse v-model="activeNames">
        ...
        <div class="msg" v-if="role!='信访室登记用户'" >
         ...
         <el-collapse-item title="信访事项信息" name="3">
          ...
          <el-collapse-item title="告知内容" name="4"  v-if="role=='信访室办结用户'&& pform.deal_report">
         ...
         <div v-if="role=='信访室登记用户'" class="msg">
          <el-collapse v-model="activeNames">
            <el-collapse-item title="受访人信息" name="1" style="margin-top: -20px">
            ...
            <el-collapse-item title="信访事项信息" name="3">
                    <el-form :inline="true" :model="pform" ref="msgForm3"  :rules="rules" label-position ="right" class="demo-form-inline">
                        ...
                        <div id="address">   
                          <el-form-item label="内容摘要" prop="nrzy">
                                <el-input type="textarea" rows="4"  style=" width:880px;"  v-model="pform.nrzy" placeholder="内容摘要"></el-input>
                          </el-form-item>
                        </div>
                        <div id="address2">   
                          <el-form-item label="备注" label-width="100px">
        ...
        <div class="btnflx"  v-if="role!='信访室办结用户'&&role!='信访室登记用户'">
          <el-button type="primary" @click="goUrl('/msg_notice')">申请办结</el-button>
          <el-button type="primary" @click="goUrl('/msg_refuse')">不予处理</el-button>
          <el-button type="primary" v-if="role!='下级单位用户'" @click="goUrl('/msg_zb','2')">转办</el-button>
         <el-button type="primary" @click="downMsg()">一键下载</el-button>

          <span style="position: absolute;right: 25px;" >处理期限:{{endd}}</span>
        </div>
        <div class="btnflx"  v-if="role=='信访室办结用户'" >
  ...
  export default {
    ...
    mounted(){
        ...
        if(this.$route.query.type==1){
             this.searchParams.start_time = this.$route.query.sdate
             this.searchParams.end_time =this.$route.query.pdate
        }
      
        if(this.$route.query.type==2){
           this.searchParams.end_time =this.$route.query.sdate
        }
    ...
    methods: {
      ...
      initData(){
          ...
          this.getHttpGet(data,'dcl',true,'get').then(res => {
              this.loading = false;
              if(res.code==0){
