    ...
    <ToolBar v-if="!flg">
          ...
          <el-collapse v-model="activeNames">
            ...
            <div class="msg">
              ...
              <el-collapse-item title="告知内容" name="4" v-if="pform.deal_report">
  ...
  export default {
    ...
    methods: {
      ...
      initData(){
          ...
          this.getHttpGet(data,'ycl',true,'get').then(res => {
              this.loading = false;
              if(res.code==0){
      ...
      openDetails(row){
          ...
          this.getHttpPost({},'msgDetail',true,'get').then(res => {
              ...
              if(res.code==0){
                    ...
                    this.$set(this.pform,'deal_report_info',res.data.result.deal_report_info)                    
