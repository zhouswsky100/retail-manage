<template>
  <div class="todo">
    ...
    <!-- <el-step v-for="item in listPros" :title="item.name"   @mouseleave.native="showFlg=false"   @mouseover.native="getData(item)" :description="item.deal_idea" ></el-step> -->
                  <el-step v-for="item in listPros" :title="item.name"    @click.native="getData2(item)" :description="item.deal_idea" ></el-step>              </el-steps>
            </div>
...
<style lang="less" scoped>
  ...
  .msg  /deep/ input[type='radio']:disabled{
    color:#333;
    opacity: 1;
    -webkit-text-fill-color: #333;  
   }
